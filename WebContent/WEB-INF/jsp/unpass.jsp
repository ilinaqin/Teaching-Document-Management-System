...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-easyui-1.4.4/locale/easyui-lang-zh_CN.js"></script>
   ...
   function formatterJson(value,row,Index){
    ...
    function formattersubmit(value, row, Index)
    {
    	//alert(value);
    	var submit = "<a href='${ pageContext.request.contextPath }/document_changeState.action?did="+value+"'><input type='button' value='提交'></a>";  
    	return submit;         
    }
    ...
    {
    	//alert(value);
    	var del="<a href='${ pageContext.request.contextPath }/document_del.action?did="+row.did+"'><input type='button' value='删除'></a>";  
    	return del;         
    }
     ...
     <%@ include file="menu.jsp" %>>
      ...
      <section id="main-content" style="padding-top:35px;">
          <section class="wrapper" style="float:right; ">
						...
						<h3 style="text-align: center;">管理员审核未通过文档</h3>
                              
	                      <div class="desc">                     
                        <!--  <table id="grid"></table>   -->
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/document_checkunpass00.action',fitColumns:true,singleSelect:true, border : false,
				            rownumbers : true,pageList: [10,20,30],pagination : true,remoteSort:false,multiSort:true">
							    <thead>
									<tr>
										<th data-options="field:'dname',width:50">名称</th>
										<th data-options="field:'category',width:50,formatter:formatterJson,sortable:true,sorter:sorttype">类型</th>
										<th data-options="field:'mantime',width:200,formatter:formattertime,sortable:true,sorter:sort">退回时间</th>
										<th data-options="field:'dimg',width:100,formatter:formatterdownload">下载</th>
										<th data-options="field:'did',width:100,formatter:formattersubmit,showColumn:true">提交</th>
										<th data-options="field:'d',width:100,formatter:formatterdelete,showColumn:true">删除</th>
										<th data-options="field:'manreason',width:100">退回原因</th>
									</tr>
							    </thead>
