...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-easyui-1.4.4/locale/easyui-lang-zh_CN.js"></script>
   ...
   function formatterJson(value,row,Index){
    ...
    function sorttype(a,b){//将时间转化为毫秒数进行排序
     ...
     /* function formatterNull(value, row, Index){//判断返回的json数据是否为空
 		//if(value==null)
 		//alert("未查询到相关记录，请重新搜索！");
 		//alert("hello");
      } */
</script>
          ...
          <section class="wrapper" style="float:right; ">
                        ...
                        <!--  <table id="grid"></table>   -->
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/document_docSearch00.action?&docsearch=${docsearch}',fitColumns:true,singleSelect:true, border : false,
