          ...
          <section class="wrapper" style="float:right; ">
                        ...
                        <!--  <table id="grid"></table>   -->
	                         ...
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/managerdocument_uncheckManagerDoc00.action',fitColumns:true,singleSelect:true, border : false,
				            rownumbers : true,pageList: [10,20,30],pagination : true,remoteSort:false,multiSort:true">
							    <thead>
									<tr>
										...
										<th data-options="field:'teachersubtime',width:200,formatter:formattertime,sortable:true,sorter:sort">提交时间</th>
