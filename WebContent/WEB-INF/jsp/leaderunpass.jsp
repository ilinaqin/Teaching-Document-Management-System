     ...
     <%@ include file="menu.jsp" %>>
      ...
      <section id="main-content" style="padding-top:35px;">
          <section class="wrapper" style="float:right; ">
						...
						<h3 style="text-align: center;">审核不通过文档</h3>
                              
	                      <div class="desc">                     
                        <!--  <table id="grid"></table>   -->
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/leaderdocument_leaderUnpass00.action',fitColumns:true,singleSelect:true, border : false,
				            rownumbers : true,pageList: [10,20,30],pagination : true,remoteSort:false,multiSort:true">
							    <thead>
									<tr>
										...
										<th data-options="field:'leadtime',width:200,formatter:formattertime,sortable:true,sorter:sort">审核时间</th>
										<th data-options="field:'leadreason',width:200">审核不通过原因</th>
