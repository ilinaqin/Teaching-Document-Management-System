     ...
     <%@ include file="menu.jsp" %>>
      ...
      <section id="main-content" style="padding-top:35px;">
          <section class="wrapper" style="float:right; ">
						...
						<h3 style="text-align: center;">审核通过文档列表</h3>
                              
	                      <div class="desc">                     
                        <!--  <table id="grid"></table>   -->
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/leaderdocument_leaderChecked00.action',fitColumns:true,singleSelect:true, border : false,
