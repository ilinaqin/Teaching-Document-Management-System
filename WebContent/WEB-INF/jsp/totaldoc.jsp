...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-easyui-1.4.4/jquery.media.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-easyui-1.4.4/locale/easyui-lang-zh_CN.js"></script>
   ...
   function formatterJson(value,row,Index){
    ...
    {
    	//alert(value);
    	var str = "<a href='${ pageContext.request.contextPath }/document_download.action?uploadFileName="+row.dimg+"'><input type='button' value='下载'></a>";  
    	return str;         
    }
    ...
    {
    	//alert(value);
    	var str = "<a href='${ pageContext.request.contextPath }/document_docview1.action?uploadFileName="+value+"'><input type='button' value='预览'></a>";  
    	return str;         
    } 
     ...
     <%@ include file="menu.jsp" %>>
      ...
      <section id="main-content" style="padding-top:35px;">
          <section class="wrapper" style="float:right; ">
						...
						<h3 style="text-align: center;">最新上传文档</h3>
                              
	                      <div class="desc">  
	                       <div id="showDoc"></div>                   
                        <!--  <table id="grid"></table>   -->
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/document_pageQuery.action',fitColumns:true,singleSelect:true, border : false,
				            rownumbers : true,pageList: [10,20,30],pagination : true,remoteSort:false,multiSort:true">
							    <thead>
									<tr>
										...
										<th data-options="field:'a',width:100,formatter:formatterdownload">下载</th>
										<th data-options="field:'dimg',width:100,formatter:formatterlook">预览</th>
									</tr>
							    </thead>
