...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery-easyui-1.4.4/locale/easyui-lang-zh_CN.js"></script>
    ...
    <script type="text/javascript">
     function formatterJson(value,row,Index){
      ...
      {
      	//alert(row.manreason);
      	var str = "<a href='${ pageContext.request.contextPath }/leaderdocument_leaderChangeState.action?did="+row.did+"'><input type='button' value='审核通过'></a>";  
      	return str;         
      }
      function onclickFunction(values){
    	//  alert("123")
    	 //alert(values)
    	  var leadreason=document.getElementById("leadreason").value;
    	  alert(leadreason)
    	  var url = '${ pageContext.request.contextPath }/leaderdocument_leaderRollbackChangeState.action';
    	    $.ajax({
    	        type: "post",
    	        url: url,
    	        data: {"did":values,"leadreason":leadreason},
    	        cache: false,
    	        async : true,//ajax为异步
    	         // dataType: "json",
    	       success: function ()
      ...
      {
      	//alert(value);
      	var str = "<input  id='leadreason' style='font-family:'楷体';font-size:13px;width:140px;' name='leadreason' type='text'  placeholder='请写入相应退回原因'/>";  
      	return str;         
      }
          ...
          <section class="wrapper" style="float:right; ">
                        ...
                        <!--  <table id="grid"></table>   -->
	                         ...
	                         <table class="easyui-datagrid" 
							    data-options="url:'${pageContext.request.contextPath}/leaderdocument_uncheckLeaderDoc00.action',fitColumns:true,singleSelect:true, border : false,
				            rownumbers : true,pageList: [10,20,30],pagination : true,remoteSort:false,multiSort:true">
							    <thead>
									<tr>
										...
										<th data-options="field:'mantime',width:200,formatter:formattertime,sortable:true,sorter:sort">提交时间</th>
